...
function App() {
  ...
  return (
    <>
      ...
      {WithSwitching(HeaderBlock, ref2, false, { subtitle: 'test', description: 'bob' })}
      {WithSwitching(HeaderBlock, ref3, false, { subtitle: 'test', description: 'no bob' })}
      <div ref={ref1}>test 1</div>
      <div ref={ref2}>test 2</div>
      <Test reference={ref3} />

      <section className="modal">{menu && <Menu onClose={handleMenuLogic} />}</section>
    </>
  );
}
